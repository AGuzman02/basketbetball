    ...
    <main className="min-h-screen bg-[#1a1a1a] text-white">
      ...
      <nav className="bg-[#0066B2] p-4">
        <div className="container mx-auto flex items-center">
          <Image src="/file.svg?height=40&width=40" alt="NBA" width={40} height={40} className="mr-4" />
      ...
      <div className="container mx-auto p-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div className="border border-gray-800 p-4">
            <div className="flex justify-between items-center">
              <div className="flex items-center gap-4">
                <Image src="/file.svg?height=30&width=30" alt="Magic" width={30} height={30} />
                <span>Magic</span>
              ...
              <div className="flex items-center gap-4">
                ...
                <span>Pelicans</span>
                <Image src="/file.svg?height=30&width=30" alt="Pelicans" width={30} height={30} />
              </div>
            </div>
          </div>
          ...
          <div className="border border-gray-800 p-4">
            <div className="flex justify-between items-center">
              <div className="flex items-center gap-4">
                <Image src="/file.svg?height=30&width=30" alt="Grizzlies" width={30} height={30} />
                <span>Grizzlies</span>
              ...
              <div className="flex items-center gap-4">
                ...
                <span>Rockets</span>
                <Image src="/file.svg?height=30&width=30" alt="Rockets" width={30} height={30} />
              </div>
            </div>
          </div>
          ...
          <div className="border border-gray-800 p-4">
            <div className="flex justify-between items-center">
              <div className="flex items-center gap-4">
                <Image src="/file.svg?height=30&width=30" alt="Lakers" width={30} height={30} />
                <span>Lakers</span>
              </div>
              <div className="flex flex-col items-center">
                <span className="text-sm text-gray-400">Today</span>
              ...
              <div className="flex items-center gap-4">
                <span>Warriors</span>
                <Image src="/file.svg?height=30&width=30" alt="Warriors" width={30} height={30} />
              </div>
            </div>
          </div>
        </div>
